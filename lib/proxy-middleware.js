...
export default function ({ options }) {
    const baseUri = process.env.LITELLM_BASE_URL || (options.configuration && options.configuration.baseUri) || "http://localhost:6655/litellm/v1";
    const apiKey = loadApiKey() || process.env.API_KEY || "";
